      ...
      <ul class="flex flex-col items-center md:flex-row">
        <li>
          <router-link to="/" class="flex items-center space-x-2">
            ...
            <span>CASTILLOMAYA</span>
          </router-link>
        </li>
        <li class="mt-3 md:ml-16 md:mt-0">
          <router-link :to="{ name: 'MoviesIndex' }">Peliculas</router-link>
        </li>
        <li class="mt-3 md:ml-6 md:mt-0">
          <router-link :to="{ name: 'ActorsIndex' }">Actores</router-link>
        </li>
        <li class="mt-3 md:ml-6 md:mt-0">
          <router-link :to="{ name: 'TvIndex' }">Tv porgramas</router-link>
        </li>
      </ul>
        ...
        <div class="mt-3 md:ml-4 md:mt-0">
          <label for="toogleA" class="flex items-center cursor-pointer">
            ...
            <div class="ml-3 font-medium text-gray-700 dark:text-gray-300">
              <span v-if="checked">Oscuro</span>
              <span v-else>Iluminado</span>
            </div>
          </label>
        </div>
      </div>
